  ...
  return (
    ...
    <Navbar/>
      {/* <section id="delivery">
        ...
        <h1 class="sec-heading">Buzzer</h1>
        <div class="col-5 delivery-img">
          <img
            src={quiz}
            alt="Productivity Delivering Experience"
      ...
      <section id="delivery" className="code_troika">
        <div className="quiz-section">
          ...
          <div className="col-7">
            <h1 className="sec-heading">Code Troika War</h1>
            <h2>Accelerating your business growth with Digital Experiences</h2>
            <p>
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
        ...
        {/* ------------------------------------------------------------------------------------------------------------------- */}
        <section id="delivery" className="Bug_bounty">
        <div className="quiz-section">
          <div className="col-5 delivery-img">
            <img
              src={quiz}
          ...
          <div className="col-7">
            <h1 className="sec-heading">Bug Bounty</h1>
            <h2>Accelerating your business growth with Digital Experiences</h2>
            <p>
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
        ...
        <div className="buzzer-section">
          <div className="col-7">
            <h1 className="sec-heading">Blind Coding</h1>
            <h2>Accelerating your business growth with Digital Experiences</h2>
            <p>
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
        ...
        <div className="quiz-section">
          ...
          <div className="col-7">
            <h1 className="sec-heading">Googler</h1>
            <h2>Accelerating your business growth with Digital Experiences</h2>
            <p>
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
        ...
        <div className="buzzer-section">
          <div className="col-7">
            <h1 className="sec-heading">Counter Strike</h1>
            <h2>Accelerating your business growth with Digital Experiences</h2>
            <p>
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
